//! demo-fiql — Phase 48 static-crate entry point.
//!
...
pub fn service() -> Box<dyn Service> {
    Box::new(DemoFiqlService)
}

struct DemoFiqlService;

impl Service for DemoFiqlService {
    ...
    fn schemas(&self) -> Vec<&'static str> {
        vec![include_str!("../schemas/fiql.graphql")]
    }
